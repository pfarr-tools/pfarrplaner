...
grep -q "\$data\['dob'\].*format('Y-m-d')" <<<"$baptisms_block"
! grep -q "format('d.m.Y'" <<<"$baptisms_block"
grep -q "format('Y-m-d H:i:s')" <<<"$baptisms_block"
...
! grep -q "format('d.m.Y'" <<<"$funerals_block"
grep -q 'Carbon::instance' <<<"$funerals_block"
...
! grep -q "format('d.m.Y'" <<<"$weddings_block"
grep -q "format('Y-m-d H:i:s')" <<<"$weddings_block"
