{!! $service->titleText(false) !!} am {!! $service->date->format('d.m.Y') !!} @if(isset($liturgy['Bezeichnung'])) ({!! $liturgy['Bezeichnung'] !!})@endif mit {!! $service->participantsText('P', true, true) !!}@if($service->youtube_prefix_description)
