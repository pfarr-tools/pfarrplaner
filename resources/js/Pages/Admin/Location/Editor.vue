        ...
        <tabs>
            <tab id="home" :active-tab="activeTab">
                ...
                <location-select name="alternate_location_id"
                                 ...
                                 v-model="myLocation.alternate_location_id" :locations="Object.values(alternateLocations)"/>
    ...
    methods: {
        saveLocation() {
            ...
            if (this.myLocation.id) {
                this.$inertia.patch(route('admin.location.update', this.myLocation.id), this.myLocation);
            } else {
                this.$inertia.post(route('admin.locations.store'), this.myLocation);
            }
        },
        addSection() {},
        editSection(section) {
