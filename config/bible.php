...
return [
    ...
    'parser' => [
        'books' => [
            ...
            '1Co' => ['1.Korinther', '1.Kor', '1Kor'],
            '2Co' => ['2.Korinther', '2.Kor', '2Kor'],
            'Gal' => ['Galater'],
            'Eph' => ['Epheser'],
            'Phi' => ['Philipper'],
            'Col' => ['Kolosser'],
            ...
            '1Ti' => ['1.Timotheus', '1.Tim', '1.Ti'],
            '2Ti' => ['2.Timotheus', '2.Tim', '2.Ti'],
            'Tit' => ['Titus'],
            'Phm' => ['Philemon'],
            'Heb' => ['Hebräer'],
            'Jam' => ['Jakobus'],
            ...
            'StZuDan' => ['Stücke zu Daniel', '2.Daniel'],
            'StZuEst' => ['Stücke zu Ester', 'Stücke zu Esther', '2.Esther', '2.Ester'],
