...
class DeleteComment extends AbstractDeleteAction implements DeletesComments
{
    ...
    public function delete(User $user, Comment $comment): ?bool
    {
        ...
        DeletedComment::dispatch($user, $comment);
        $this->messages = ['success' => 'Der Kommentar wurde gelöscht.'];
