...
class LocationUnitTest extends AbstractModelUnitTest
{
    ...
    /** Override: sync the Location's city for update permission */
    ...
    /** Override: sync the Location's city for delete permission */
